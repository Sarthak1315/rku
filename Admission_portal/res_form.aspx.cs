    ...
    public partial class res_form : System.Web.UI.Page
    {
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            if (ath)
            {
                ...
                {
                    dbconn();
                    String inst = "INSERT INTO Registration(stream,d_id,First_name,Middle_name,Last_name,birth_date,Category,Gender,mobile_number,Email,Ssc_per,Hsc_per,Address,Password) Values('" + ddl_stream.SelectedValue + "'," + ddl_dept.SelectedValue + ",'" + txt_fname.Text + "','" + txt_mname.Text + "','" + txt_lname.Text + "','" + txt_birth.Text + "','" + ddl_category.SelectedValue + "','" + rdl_gender.SelectedValue + "'," + txt_mobile.Text + ",'" + txt_email.Text + "'," + txt_ssc.Text + "," + txt_hsc.Text + ",'" + txt_add.Text + "','"+txt_pass.Text+"');";
                    //Response.Write(inst);
